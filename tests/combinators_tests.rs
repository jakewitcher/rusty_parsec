...
fn succeeds_parsing_tuple_2() {
    ...
    let actual =
        tuple_2(p_u32(), p_string("hello".to_string()))
...
fn succeeds_parsing_tuple_3() {
    ...
    let actual =
        tuple_3(p_string("hello".to_string()), p_u32(), p_true())
...
fn succeeds_parsing_tuple_4() {
    ...
    let actual =
        tuple_4(p_string("hello".to_string()), p_u32(), p_true(), p_f32())
...
fn succeeds_parsing_tuple_5() {
    ...
    let actual =
        tuple_5(p_string("hello".to_string()), p_u32(), p_true(), p_f32(), satisfy(Box::new(|c| c == 'a')))
